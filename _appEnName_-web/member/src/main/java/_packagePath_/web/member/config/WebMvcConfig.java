package ${packageName}.web.member.config;
...
@ComponentScan(basePackages = "${packageName}.web.member", includeFilters = {@Filter(RestController.class), @Filter(Component.class)}, useDefaultFilters = false)
